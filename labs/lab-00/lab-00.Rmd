...
```{r setup-tibble}
usernames <- c("wilsonamy", "shuaibtw", "DTICK0302", "username 3", "username 4") #Extend if necessary
nums <- c(18, 13, 9, NA, NA) #Extend if necessary
colours <- c("powderblue", "peachpuff2", "ivory2", "colour 2", "colour 4") #Extend if necessary
hobbies <- c("Hiking", "piano", "basketball", "Hobby 3", "Hobby 4") #Extend if necessary
